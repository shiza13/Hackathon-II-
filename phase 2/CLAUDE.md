...
### Specialized Agents
- **Auth Agent**: Use for authentication - Implement user signup/signin using Better Auth
- **Frontend Agent**: Use for frontend development (e.g., Next.js) - Build responsive frontend interface
- **DB Agent**: Use for database design and operations - Store data in Neon Serverless PostgreSQL database
- **Backend Agent**: Use for FastAPI development - Create RESTful API endpoints
